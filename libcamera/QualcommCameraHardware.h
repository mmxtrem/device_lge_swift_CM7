...
typedef enum {
	CAMERA_WB_MIN_MINUS_1, //0
	CAMERA_WB_AUTO = 1,  /* This list must match aeecamera.h */
	CAMERA_WB_INCANDESCENT, //2
	CAMERA_WB_SUNNY, //3
	CAMERA_WB_FLUORESCENT, //4
	CAMERA_WB_CLOUDY, //5
	CAMERA_WB_CUSTOM, //6
	CAMERA_WB_DAYLIGHT, //7
	CAMERA_WB_CLOUDY_DAYLIGHT, //8
	CAMERA_WB_TWILIGHT, //9
	CAMERA_WB_SHADE, //10
	CAMERA_WB_MAX_PLUS_1 //11
} camera_wb_type;
...
/*
 TODO LIST 
 command suported by sensor 
 config:
 CFG_SET_MODE
 CFG_SET_EFFECT
 CFG_SET_ZOOM_VIDEO
 CFG_SET_PARM_AF_MODE  - CAMERA_SET_PARM_AUTO_FOCUS - ok
 CFG_SET_DEFAULT_FOCUS
 CFG_MOVE_FOCUS
 CFG_SET_CANCEL_FOCUS -  CAMERA_AUTO_FOCUS_CANCEL - ok
 ...
 MSM_CAM_IOCTL_GET_STATS
 MSM_CAM_IOCTL_ENABLE_VFE
 MSM_CAM_IOCTL_DISABLE_VFE
 MSM_CAM_IOCTL_VFE_APPS_RESET
 MSM_CAM_IOCTL_RELEASE_STATS_BUFFER
 MSM_CAM_IOCTL_AXI_CONFIG - ок 
 MSM_CAM_IOCTL_SET_CROP
 MSM_CAM_IOCTL_PICT_PP
 MSM_CAM_IOCTL_PICT_PP_DONE
 MSM_CAM_IOCTL_SENSOR_IO_CFG
 MSM_CAM_IOCTL_FLASH_LED_CFG
 
 */


//#define CAMERA_SET_PARM_ANTIBANDING 0 // unk 

enum camera_ops {
   CAMERA_SET_PARM_ENCODE_ROTATION, // not used 
   CAMERA_SET_PARM_DIMENSION=1,// ida 1(findsensortypeта)  kernel - 
   CAMERA_SET_PARM_ZOOM = 2 , //ida  =  2 
   CAMERA_SET_PARM_SENSOR_POSITION, // FIXME UNSUPORTED
   CAMERA_SET_PARM_SHARPNESS, //UNSUPPORTED 
   CAMERA_SET_PARM_LUMA_ADAPTATION, //UNSUPPORTED
   CAMERA_SET_PARM_CONTRAST = 13,
    CAMERA_SET_PARM_EXPOSURE_COMPENSATION,
    CAMERA_SET_PARM_BRIGHTNESS = 8, // from ida 
    CAMERA_SET_PARM_FOCUS_RECT,
    CAMERA_SET_PARM_HUE,
    CAMERA_SET_PARM_SATURATION,
    CAMERA_SET_PARM_EXPOSURE,// setAutoExposure - unsupported
    CAMERA_SET_PARM_AUTO_FOCUS = 14, // ida 
     CAMERA_SET_PARAM_FOCUS_MODE = 31,  //  ida ok 
    CAMERA_SET_PARM_WB = 15,  // ida 15 ???? + // ok
    CAMERA_SET_PARM_EFFECT = 16 , // ida 16 ????? +  //ok 
    CAMERA_SET_PARM_FPS = 10,  // setPreviewFrameRate = not supported
    CAMERA_SET_PARM_FLASH,
   CAMERA_SET_PARM_NIGHTSHOT_MODE,
    CAMERA_SET_PARM_REFLECT,
    CAMERA_SET_PARM_PREVIEW_MODE,
    CAMERA_SET_PARM_ANTIBANDING = 17 , 
    ...
    CAMERA_SET_PARM_ISO = 27, // ida 
    CAMERA_SET_PARM_BESTSHOT_MODE, //not used in code 
    CAMERA_SET_PARM_PREVIEW_FPS,
    CAMERA_SET_PARM_AF_MODE, //not used in code 
    ...
    CAMERA_SET_PARM_HJR=37, //removed 
    CAMERA_SET_PARM_ROLLOFF, //not suported 
    CAMERA_STOP_PREVIEW=39, //ida 
    CAMERA_START_PREVIEW=40,//ida
    CAMERA_START_SNAPSHOT=41,//ida
    CAMERA_START_VIDEO = 57,//ida 
    CAMERA_STOP_SNAPSHOT=43, //ida
    CAMERA_EXIT=44, //ida
    CAMERA_STOP_VIDEO=58, //ida
    CAMERA_START_RECORDING = 59 , //ida :native_start_recording
    CAMERA_STOP_RECORDING = 60 , //ida native_stop_recording
    CAMERA_GET_PARM_MAXZOOM = 48, // ida native_get_maxzoom
    CAMERA_START_RAW_SNAPSHOT=42, //ida
    CAMERA_SET_PARM_LED_MODE=50,
    CAMERA_GET_PARM_AF_SHARPNESS,
    CAMERA_SET_MOTION_ISO,
    CAMERA_AUTO_FOCUS_CANCEL, // not supported
    CAMERA_GET_PARM_FOCUS_STEP,
    CAMERA_ENABLE_AFD, //nusupported setAntibanding
    CAMERA_PREPARE_SNAPSHOT=55,//ida
    CAMERA_SET_FPS_MODE,
    CAMERA_SET_PARM_SCENE_MODE,
};


//#define CAMERA_SET_PARM_ZOOM  CFG_SET_ZOOM_VIDEO
//#define CAMERA_SET_PARM_AUTO_FOCUS  CFG_SET_PARM_AF_MODE
//#define CAMERA_AUTO_FOCUS_CANCEL CFG_SET_CANCEL_FOCUS 
//#define CAMERA_SET_PARM_BRIGHTNESS CFG_SET_BRIGHTNESS
//#define CAMERA_SET_PARM_WB  CFG_SET_WB
//#define CAMERA_SET_PARM_ISO  CFG_SET_ISO
//#define CAMERA_SET_PARAM_FOCUS_MODE CFG_SET_PARM_AF_MODE 
